...
export default function PuzzleScreen() {
  ...
  const handleOptionPress = (index: number) => {
    ...
    setTimeout(() => {
      Alert.alert('Interstitial Ad', 'Pretend a full-screen video ad is playing right now!', [
        { text: 'Close Ad' }
      ]);
    }, 600);
  };
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          onPress: () => {
            // Mock Ad Watch
            Alert.alert("Rewarded Ad", "Pretend a video ad played.", [
              {
                text: "Close",
                onPress: () => {
            ...
            {puzzle.options.map((option, index) => {
              ...
              return (
                ...
                >
                  <Text style={[
                    styles.optionText,
                    showResult && isCorrect && { color: Colors.secondary, fontWeight: '700' }
                  ]}>
                    {option}
                  </Text>
                  {showResult && isCorrect && <CheckCircle size={20} color={Colors.secondary} />}
            ...
            <Animated.View style={styles.resultContainer}>
              ...
              {isCompletedToday && (
                <Pressable onPress={loadBonusPuzzle} style={styles.bonusButton}>
                  <Play size={20} color={Colors.surface} style={{ marginRight: 8 }} />
